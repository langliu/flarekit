...
import {
  ...
  ChartTooltipContent,
  type ChartConfig,
} from '@flarekit/ui/components/chart'
import { Checkbox } from '@flarekit/ui/components/checkbox'
import {
  Drawer,
  DrawerClose,
  DrawerContent,
  ...
  DrawerTitle,
  DrawerTrigger,
} from '@flarekit/ui/components/drawer'
import {
  DropdownMenu,
...
function TableCellViewer({ item }: { item: z.infer<typeof schema> }) {
  ...
  return (
    <Drawer swipeDirection={isMobile ? 'down' : 'right'}>
      <DrawerTrigger
        render={<Button variant='link' className='text-foreground w-fit px-0 text-left' />}
      >
        {item.header}
      </DrawerTrigger>
      <DrawerContent>
